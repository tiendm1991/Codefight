...
public class TournamentDay38 {
  ...
  private static boolean passwordCheck(String inputString) {
    ...
    boolean containsDigits = false, containsCapitals = false, containsSmallLetters = false;
      ...
      boolean special(int num) {
        ...
        while (num != 0) {
          ...
          if (digit == 6)
            ...
            digits.add(0);
          if (digit == 1 || digit == 2 || digit == 3 || digit == 4 || digit == 5 || digit == 7)
            return false;
          num /= 10;
        }
        Collections.reverse(digits);
  ...
  public static void main(String[] args) {
    // System.out.println(houseNumbersSum(new int[]{5, 1, 2, 3, 0, 1, 5, 0,
    // 2}));
    // System.out.println(variableName("var_1__Int"));
    // System.out.println(bfsConnectedComponents(new boolean[][]{{false,
    ...
    // System.out.println(Arrays.toString(bfsDistancesUnweightedGraph(new
    // boolean[][]{{false, false, true}, {false, false, true}, {true, true,
    // false}}, 0)));
