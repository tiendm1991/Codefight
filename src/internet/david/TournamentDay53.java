...
public class TournamentDay53 {
  ...
  private static int rectanglesIntersection(int[] a, int[] b, int[] c, int[] d) {
    ...
    int x11 = a[0], x12 = b[0], x21 = c[0], x22 = d[0], y11 = a[1], y12 = b[1], y21 = c[1],
        y22 = d[1];
  ...
  public static void main(String[] args) {
    ...
    // ".##.#", ".#.##", "....."})));
    // System.out.println(Arrays.toString(digitalSumSort(new int[]{13, 20,
    // 7, 4})));
    // System.out.println(kthDivisor(63, 4));
    // System.out.println(rectanglesIntersection(new int[]{0, 0}, new
    // int[]{2, 2}, new int[]{1, 1}, new int[]{3, 3}));
    // System.out.println(rectanglesIntersection(new int[]{3, -3}, new
    // int[]{-3, 3}, new int[]{-1, 0}, new int[]{2, 1}));
