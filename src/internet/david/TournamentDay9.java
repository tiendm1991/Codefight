...
public class TournamentDay9 {
  ...
  static int adjacentElementsProduct(int[] inputArray) {
    ...
    int best = inputArray[0] * inputArray[1], cur = best;
  ...
  public static void main(String[] args) {
    ...
    // System.out.println(adjacentElementsProduct(new int[]{3, 6, -2, -5, 7,
    // 3}));
    // System.out.println(maxSubarray(new int[]{-1, 7, -2, 3, 4, 0, 1,
    // -1}));
    // System.out.println(segmentDeletionSlow(new int[]{4, 1, 1}, new
    // int[]{7, 3, 6}));
