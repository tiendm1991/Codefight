...
public class TournamentDay47 {
  ...
  private static String concatenationProcess(String[] init) {
    ...
    while (vector.size() > 1) {
      int minInd1 = 0, minInd2 = vector.size() - 1;
      ...
      for (int i = vector.size() - 2; i >= 0; i--) {
        if (vector.get(i).length() < vector.get(minInd2).length() && i != minInd1) {
          minInd2 = i;
        }
      }
  ...
  public static void main(String[] args) {
    // System.out.println(absoluteValuesSumMinimization(new int[]{2, 4,
    // 7}));
    // System.out.println(absoluteValuesSumMinimization(new int[]{1, 1, 3,
    // 4}));
    // System.out.println(absoluteValuesSumMinimization(new int[]{23}));
    /*
     * System.out.println(Arrays.toString(textJustification(new String[]{"This", "is", "an",
     * "example", "of", "text", "justification."}, 3)));
     */
    // System.out.println(secretCode(new boolean[]{false, true, false,
    // false, false, false, false, false, false, false}));
    // System.out.println(firstNotDivisible(new int[]{2, 3, 4}, 14));
    // System.out.println(segmentsUnion(new int[]{1, 2, 5}, new int[]{3, 4,
    // 6}));
    System.out.println(dfsCheckTree(
