...
public class TournamentDay28 {
  ...
  public static void main(String[] args) {
    ...
    /*
     * System.out.println(Arrays.toString(bfsDistancesUnweightedGraph(new boolean[][]{{false, false,
     * true}, {false, false, true}, {true, true, false}}, 0)));
     */
    ...
    // System.out.println(arrayConversion(new int[]{1, 2, 3, 4, 5, 6, 7,
    // 8}));
