...
public class TournamentDay26 {
  ...
  public static void main(String[] args) {
    ...
    // System.out.println(fractionMultiplication(new int[]{3, 2}, new
    // int[]{2, 5}));
    // System.out.println(evenNumbersBeforeFixed(new int[]{1, 4, 2, 6, 3,
    // 1}, 6));
    // System.out.println(noAdjacentBits(22));
    // System.out.println(isLuckyNumber(47));
    // System.out.println(validRoute(new int[]{500, 500}, new int[]{1000,
    // 3000}, new int[]{2000, 4000}));
