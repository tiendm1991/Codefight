...
public class TournamentDay40 {
  ...
  private static ArrayList<Integer> myFilter(ArrayList<Integer> inputArray, int extraElement) {
  ...
  public static void main(String[] args) {
    ...
    // System.out.println(caesarBoxCipherEncoding("a message"));
    // System.out.println(isTournament(5, new int[]{2, 1, 3, 4, 4, 4, 1, 2,
    // 3, 4}, new int[]{3, 2, 1, 3, 2, 1, 5, 5, 5, 5}));
    // System.out.println(maxSumProduct(new int[]{-10, 10, 20, 90}, new
    // int[]{-1, 2, 3, 4, 5}, 5));
