...
public class TournamentDay2 {
  ...
  static int segmentsIntersection(int[] left, int[] right) {
    ...
    /*
     * Set<Integer> s1 = new HashSet<Integer>(Arrays.asList(array1)); Set<Integer> s2 = new
     * HashSet<Integer>(Arrays.asList(array2)); s1.retainAll(s2);
     */
  ...
  public static void main(String[] args) {
    ...
    // System.out.println(segmentsIntersection(new int[]{1, 2, 3}, new
    // int[]{5, 4, 11}));
  }
