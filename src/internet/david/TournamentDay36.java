...
public class TournamentDay36 {
  ...
  public static void main(String[] args) {
    ...
    // System.out.println(isIdentityMatrix(new int[][]{{1, 0, 0}, {0, 1, 0},
    // {0, 0, 1}}));
    // System.out.println(halvingSum(25));
    // System.out.println(checkEqualFrequency(new int[]{1, 2, 2, 1}));
    // System.out.println(areSimilar(new int[]{1, 2, 3}, new int[]{2, 1,
    // 3}));
    System.out.println(
        Arrays.toString(sumOfBigNumbers(10, new int[] {1, 2, 3, 4, 5}, new int[] {9, 8, 7, 6, 5})));
  }
