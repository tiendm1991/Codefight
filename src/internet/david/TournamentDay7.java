...
public class TournamentDay7 {
  ...
  static boolean bishopAndPawn(String cell1, String cell2) {
    ...
    int x1 = p.getX(cell1.charAt(0)), y1 = p.getY(cell1.charAt(1)), x2 = p.getX(cell2.charAt(0)),
  ...
  static int sequenceElement(int[] a, int n) {
    ...
    /*
     * int[] result = new int[5]; for (int i = 0; i < a.length; i++) { result[i] = a[i]; } int a1,
     * a2, a3, a4, a5; for (int i = 0; i <= n - 5; i++) { a1 = result[0]; a2 = result[1]; a3 =
     * result[2]; a4 = result[3]; a5 = result[4]; result[4] = (a1 + a2 + a3 + a4 + a5) % 10;
     * result[3] = a5; result[2] = a4; result[1] = a3; result[0] = a2; } return result[4];
     */
  }
  ...
  public static void main(String[] args) {
    ...
    // System.out.println(arrayMaxConsecutiveSum(new int[]{2, 3, 5, 1, 6},
    // 2));
