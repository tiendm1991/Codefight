...
public class TournamentDay45 {
  ...
  private static int chessKnightMoves(String cell) {
    int x = cell.charAt(0) % 65, y = +cell.charAt(1) - '0' - 1;
    // console.log(x, y);
    int c = 0;
  ...
  public static void main(String[] args) {
    /*
     * System.out.println(squareInTheLabyrinth(new boolean[][]{{true, true, true, true}, {true,
     * true, false, true}, {true, true, true, true}, {true, true, true, true}}));
     */
    // System.out.println(centuryFromYear(100));
    // System.out.println(Arrays.toString(fibonacciSum(10)));
    // System.out.println(freeTickets(new int[]{1, 2, 3}, new int[]{1, 2,
    // 3}, 3));
