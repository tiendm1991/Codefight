...
public class Tournament {
  ...
  public static void main(String[] args) {
    ...
    // System.out.println(blackAndWhiteBoard(3, 5, new String[]{"v 1 2", "x
    // 2 2", "v 1 2", "> 2 1", "x 2 3", "> 2 1", "< 2 0"}));
    System.out.println(blackAndWhiteBoard(3, 3, new String[] {"> 1 0", "v 0 1", "< 1 2", "^ 2 1",
        "x 1 1", "> 1 0", "v 0 1", "< 1 2", "^ 2 1"}));

    // Uber parking
    /*
     * int[] carDimensions = {2, 1}; int[][] parkingLot = {{1,0,1}, {1,0,1}, {1,1,1}}; int[]
     * luckySpot = {0, 1, 1, 1};
     * 
     * boolean res = parkingSpot(carDimensions, parkingLot, luckySpot); System.out.println(res);
     */

    /*
     * int[] boxes = {4, 3, 1, 1, 0, 0}; System.out.println(boxPiles(boxes));
     */

    // System.out.println(isMonotonous(new int[]{1, 4, 5, 7, 9}));
    // System.out.println(isMonotonous(new int[]{3, 3}));

    // System.out.println(factorizedGCD(new int[]{2, 3, 3, 3, 5}, new
    // int[]{2, 2, 2, 2, 3, 3}));
