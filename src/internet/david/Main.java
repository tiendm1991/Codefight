...
public class Main {
  ...
  public static double[] fareEstimator(int ride_time, int ride_distance, double[] cost_per_minute,
  ...
  public static void main(String[] args) {
    ...
    /*
     * double[] dep = new double[2]; dep[0] = 0.4; dep[1] = 1; double[] dest = new double[2];
     * dest[0] = 0.9; dest[1] = 3;
     */
