...
public class TournamentDay3 {
  ...
  public static void main(String[] args) {
    // System.out.println(avoidObstacles(/*new int[]{5, 3, 6, 7, 9}*/new
    // int[]{2, 3}));
    // System.out.println(maxFraction(new int[] {5, 2, 5}, new int[]{6, 3,
    // 4}));
    // System.out.println(multiplicationOfBigNumbers(10, new int[] {9, 8, 7,
    // 6}, new int[]{7, 6, 5}));
