...
public class TournamentDay50 {
  ...
  private static int[] troubleFiles2(int[][] files, int[] backups) {
    ...
    int tickIdx = 0;
    for (int tick = Math.min(files[0][0], backups[0]); tick <= Math.max(files[files.length - 1][0],
        backups[backups.length - 1]); tick++) {
      ...
      for (int j = 0; j < files.length; j++) {
        if (!processedFiles[j] && files[j][0] == tick) {
          if (files[j][0] <= backUpProcessStartTime) {
            ...
            processedFiles[j] = true;
            if (files[j][0] <= backUpProcessStartTime + filesToProcess
                || tick <= backUpProcessEndTime) {
              troubleFilesCount[tickIdx]++;
            } else {
  ...
  public static void main(String[] args) {
    ...
    /*
     * System.out.println(Arrays.toString(troubleFiles2(new int[][]{{461618501, 3}, {461618502, 1},
     * {461618504, 2}, {461618506, 5}, {461618507, 6}}, new int[]{461618501, 461618502, 461618504,
     * 461618505, 461618506}))); System.out.println(Arrays.toString(troubleFiles2(new
     * int[][]{{461618501, 3}, {461618502, 1}, {461618504, 2}, {461618506, 5}, {461618507, 6}}, new
     * int[]{461618504}))); System.out.println(Arrays.toString(troubleFiles2(new int[][]{{461618501,
     * 3}, {461618502, 1}, {461618504, 2}, {461618506, 5}, {461618507, 6}, {461618509, 1},
     * {461618509, 1}, {461618599, 4}}, new int[]{461618502, 461618509})));
     * 
     * System.out.println(Arrays.toString(troubleFiles2(new int[][]{{461618500, 7}, {461618505, 9},
     * {461618510, 4}, {461618515, 5}, {461618518, 9}}, new int[]{461618504, 461618509})));
     */
