...
public class TournamentDay11 {
  ...
  static int arrayMode(int[] sequence) {
    ...
    int maxValueInMap = (Collections.max(hashMap.values())); // This will
                                                             // return
                                                             // max value
                                                             // in the
                                                             // Hashmap
    for (Map.Entry<Integer, Integer> entry : hashMap.entrySet()) { // Itrate
                                                                   // through
                                                                   // hashmap
  ...
  public static void main(String[] args) {
    ...
    // 0, 0}, {0, 3, 3}}));
    // System.out.println(isLowerTriangularMatrix(new int[][]{{1, 0, 1}, {0,
    // 5, 0}, {2, 0, 3}}));
    // System.out.println(crossroads(new int[]{1, 5, 6, 7}, new int[]{3,
    // 10}, 2));
