...
public class SwitchingTumblers {
  ...
  boolean solve(int i, List<ArrayList<Integer>> lsTumblers, boolean[][] x, boolean[][] p,
      boolean[] visited) {
    visited[i] = true;
  ...
  public static void main(String[] args) {
    ...
    String[] tumblers = {"a7, d5, e1, f7, g1", "c3, d9, f8, g9, i8",
        ...
        "b6, c7, d6, e7, g4, g7", "d5, e8, f3, h2, h4, j3",
