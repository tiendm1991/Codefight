package tiendm.codefight.challenge.y2018.sep;
...
public class SmallestComponent {
  ...
  private void check(Character[][] charMatrix, List<ArrayList<String>> ls,
      Map<String, Integer> traceMap, int i, int j) {
    int a = i - 1;
    int b = j - 1;
  ...
  public static void main(String[] args) {
    ...
    String[] str = {"1111111111111111", "1000111111100011", "0001111111101111", "1101111111001111",
        "1100011110000001", "1111000100100111", "1110000001100111", "1100110111110011",
        "1001100011111001", "1011001000111111", "1011111110001111", "1111111111111111"};
