package tiendm.codefight.challenge.y2018.august;
...
public class RockPaperScissor {
  ...
  private char caculate(char current, char opponent, int resultPrev,
      Map<Character, Integer> frequently, String you) {
    if (resultPrev == 1) {
      return opponent;
    } else if (resultPrev == -1) {
  ...
  int compare(char current, char opponent, Map<Character, Character> mapWin,
      Map<Character, Character> mapLose) {
